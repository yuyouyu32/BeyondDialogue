...
from Metrics.coherence_m import coherence_m
from Metrics.emotion_m import emotion_m
from Metrics.human_likeness_m import human_likeness_m
from Metrics.personality_m import personality_m
from Metrics.relationship_m import relationship_m
from Metrics.rolechoice_m import rolechoice_m
...
def main():
    ...
    print("================Running Metrics.human_likeness================")
    cn_result["human_likeness"], en_result["human_likeness"], all_result["human_likeness"] = human_likeness_m()
    print("================Running Metrics.rolechoice================")
    cn_result["rolechoice"], en_result["rolechoice"], all_result["rolechoice"] = rolechoice_m()
    print("================Running Metrics.coherence================")
    cn_result["coherence"], en_result["coherence"], all_result["coherence"] = coherence_m()
...
if __name__ == '__main__':
    ...
    for language, result in zip(["cn", "en", "all"], [cn_result, en_result, all_result]):
        ...
        include_metrics = ['character', 'style', 'emotion', 'relationship', 'personality']
        ...
        df = df[["character", "style", "emotion", "relationship", "personality", "average_score", "human_likeness", "rolechoice", "coherence"]]

        df.to_excel(f"../main_results/Metrics_{language}_result.xlsx")
        print(f"Metrics_{language}_result.xlsx saved successfully!")